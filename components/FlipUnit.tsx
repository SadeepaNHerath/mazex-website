...
export default function FlipUnit({ value, label }: FlipUnitProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-maze-muted-strong sm:text-xs">
        {label}
      </span>
    </div>
  );
    ...
    <div className="relative h-20 w-14 sm:h-28 sm:w-20 [perspective:1000px] font-sans">
      ...
      <div className="absolute inset-0 flex flex-col">
        ...
        <div className="relative h-1/2 w-full overflow-hidden rounded-t-md border-x border-t border-[#CBD5E1]/40 bg-[#F1F5F9]">
          <div 
            className="absolute inset-x-0 top-0 flex h-[200%] items-center justify-center text-5xl font-extrabold tracking-tighter text-[#1E293B] sm:text-7xl"
        ...
        <div className="relative h-1/2 w-full overflow-hidden rounded-b-md border-x border-b border-[#CBD5E1]/40 bg-[#F1F5F9] shadow-lg">
          <div 
            className="absolute inset-x-0 bottom-0 flex h-[200%] items-center justify-center text-5xl font-extrabold tracking-tighter text-[#1E293B] sm:text-7xl"
            suppressHydrationWarning
          >
            {prevDigit}
          </div>
